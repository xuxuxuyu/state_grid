    ...
    <div class="wrapper"> 
        ...
        <el-row class="center" type="flex" justify="space-between">
            <el-col>
                <div>
                    <span>工作站:</span>
                    <el-input class="headInput" placeholder="可以模糊下拉选查询"></el-input>
                </div> 
            </el-col>
            <el-col>
                <div>
                    <span>员工姓名:</span>
                    <el-input class="headInput" v-model="personneName" placeholder="可以模糊下拉选查询"></el-input>
                </div>
            </el-col>
            <el-col>
                <div>
                    <span>员工工号:</span>
                    <el-input class="headInput" v-model="personnelId" placeholder="工号、名称"></el-input>
                </div>
            </el-col>
            <el-col>
                <div>
                    <span>设备编号:</span>
                    <el-input class="headInput" v-model="equipmentId" placeholder="设备编号"></el-input>
                </div>
            </el-col>
            <el-col>
        ...
        <el-row class="btn">
            ...
            <el-dialog title="新增设备" :visible.sync="dialogAdd">
                <el-form :model="form">
                    <el-form-item label="设备编号">
                        <el-input type="text" v-model="form.eqnum" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="设备名称">
                        <el-input type="text" v-model="form.eqname" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="员工编号">
                        <el-input type="text" v-model="form.pernum" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="设备类型"><br>
            ...
            <el-button @click="dialogUpdate = true;upchange()">修改</el-button>
            <el-dialog title="修改设备" :visible.sync="dialogUpdate">
                <el-form :model="form">
                    <el-form-item label="设备编号">
                        <el-input type="text" v-model="update.eqnum" autocomplete="off" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="设备名称">
                        <el-input type="text" v-model="update.eqname" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="员工编号">
                        <el-input type="text" v-model="update.pernum" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="设备类型"><br>
                        <el-select v-model="value" placeholder="请选择">
                            <el-option
        ...
        <el-row class="bottom">
            <el-table :data=tableData @selection-change="getCurrentTableId">
                ...
                <el-table-column prop="personnelName" label="员工姓名" ></el-table-column>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            getEquipmentList(){
                httpGet("/equipment/list",{pageSize:"10",pageNo:"1"}).then((res)=>{
                    if(res.success){
            ...
            //添加设备
            add(){
                if(this.form.eqnum!=""&&this.form.eqname!=""&&this.form.pernum!=""&&this.value!=""){
                    this.getEquipmentList()
